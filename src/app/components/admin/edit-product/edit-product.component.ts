...
export class EditProductComponent implements OnInit {
  ...
  constructor(private http: ConfigService, private router: Router, private route: ActivatedRoute, private config: Config) { }
  ...
  ngOnInit(): void {
    ...
    this.http.getDataFromSpecificProduct(this.id).subscribe(data => 
      { 
        ...
        this.image = this.config.URL_SERVER + data.images[0];
      });    
  }
